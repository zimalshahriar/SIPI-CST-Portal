...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm_delete'])) {
    ...
    if ($deleteQuery->execute()) {
        echo "<script>alert('Grade report deleted successfully!'); window.location.href='manage_grade_report.php';</script>";
        exit;
    } else {
...
<div class="container mt-5">
    ...
    <p>Are you sure you want to delete this grade report </strong>?</p>
